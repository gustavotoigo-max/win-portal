...
export const dictionaries = {
  pt: {
    ...
    product: {
      download: "Download",
      version: "Versao",
      publishedAt: "Atualizado em",
      releaseUnavailable: "Release ainda nao publicado",
    ...
    auth: {
      ...
      demoNotice: "Quando as variaveis do Neon estiverem configuradas, este formulario fara login real.",
      confirmEmailNotice: "Cadastro criado. Confirme seu e-mail antes de entrar.",
      emailNotConfirmed: "E-mail ainda nao confirmado. Abra o link de confirmacao enviado para sua caixa de entrada.",
      invalidCredentials: "E-mail ou senha incorretos. Confira os dados e tente novamente.",
      emailInUse: "Este e-mail ja esta sendo usado. Entre na conta existente ou use a recuperacao de senha.",
      passwordError: "A senha informada nao atende aos requisitos. Use pelo menos 6 caracteres.",
      tooManyRequests: "Muitas tentativas em pouco tempo. Aguarde alguns instantes antes de tentar novamente.",
      genericError: "Nao foi possivel concluir o acesso agora. Confira os dados e tente novamente.",
      ssoEmailRequired: "Informe seu e-mail corporativo antes de continuar com SSO.",
      forgotTitle: "Recuperar senha",
      forgotText: "Informe seu e-mail para receber o link de troca de senha.",
      sendReset: "Enviar e-mail de troca",
      resetSent: "Se este e-mail existir, enviaremos um link seguro para trocar a senha.",
      resetError: "Nao foi possivel enviar o e-mail de troca de senha agora.",
      backToLogin: "Voltar para login",
      resetTitle: "Trocar senha",
      resetText: "Crie uma nova senha para continuar acessando sua conta.",
    ...
    admin: {
      ...
      accessDeniedText: "Voce esta logado, mas este e-mail ainda nao esta marcado como administrador no Neon.",
      accessDeniedSql: "No Neon SQL Editor, atualize public.profiles e defina role = 'admin' para este e-mail. Depois saia e entre novamente.",
  ...
  en: {
    ...
    product: {
      download: "Download",
      version: "Version",
      publishedAt: "Updated on",
      releaseUnavailable: "Release not published yet",
    ...
    auth: {
      ...
      demoNotice: "Once the Neon environment variables are configured, this form will perform real auth.",
      confirmEmailNotice: "Account created. Confirm your email before signing in.",
      emailNotConfirmed: "Email is not confirmed yet. Open the confirmation link sent to your inbox.",
      invalidCredentials: "Incorrect email or password. Check the information and try again.",
      emailInUse: "This email is already in use. Sign in to the existing account or recover the password.",
      passwordError: "The password does not meet the requirements. Use at least 6 characters.",
      tooManyRequests: "Too many attempts in a short time. Wait a moment before trying again.",
      genericError: "We could not complete access right now. Check the information and try again.",
      ssoEmailRequired: "Enter your corporate email before continuing with SSO.",
      forgotTitle: "Recover password",
      forgotText: "Enter your email to receive a password reset link.",
      sendReset: "Send reset email",
      resetSent: "If this email exists, we will send a secure password reset link.",
      resetError: "We could not send the password reset email right now.",
      backToLogin: "Back to login",
      resetTitle: "Reset password",
      resetText: "Create a new password to keep accessing your account.",
    ...
    admin: {
      ...
      accessDeniedText: "You are signed in, but this email is not marked as an administrator in Neon yet.",
      accessDeniedSql: "In the Neon SQL Editor, update public.profiles and set role = 'admin' for this email. Then sign out and sign in again.",
